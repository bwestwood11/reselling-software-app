...
export async function mercariRoutes(fastify: FastifyInstance) {
  ...
  // ?limit=100
  fastify.get("/categories", { preHandler: [requireAuth, requireActiveSubscription] }, async (request, reply) => {
  ...
  fastify.get("/categories/count", { preHandler: [requireAuth, requireActiveSubscription] }, async (_request, reply) => {
  ...
  fastify.post("/extension/heartbeat", { preHandler: [requireAuth, requireActiveSubscription] }, async (request, reply) => {
    await recordExtensionHeartbeat(request.user!.id);
  ...
  fastify.get("/settings", { preHandler: [requireAuth, requireActiveSubscription] }, async (_request, reply) => {
    return reply.send({
      success: true,
  ...
  fastify.patch("/settings", { preHandler: [requireAuth, requireActiveSubscription] }, async (_request, reply) => {
  ...
  fastify.post("/shipping/carriers", { preHandler: [requireAuth, requireActiveSubscription] }, async (request, reply) => {
    const body = request.body as {
      categoryId?: number;
  ...
  fastify.post("/login/start", { preHandler: [requireAuth, requireActiveSubscription] }, async (request, reply) => {
  ...
  fastify.post("/login/verify", { preHandler: [requireAuth, requireActiveSubscription] }, async (request, reply) => {
